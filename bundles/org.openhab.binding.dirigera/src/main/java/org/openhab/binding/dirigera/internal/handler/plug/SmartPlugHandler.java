                ...
                if (targetChannel != null) {
                    switch (targetChannel) {
                        ...
                        case CHANNEL_ENERGY_RESET_DATE:
                            ...
                            updateState(new ChannelUID(thing.getUID(), CHANNEL_ENERGY_RESET_DATE), new DateTimeType(
                                    restTime.atZone(DirigeraHandlerFactory.TIMEZONE_PROVIDER.getTimeZone())));
                            break;
                    }
                }
            }
