        ...
        if (data.has(Model.ATTRIBUTES)) {
            ...
            if (!attributes.isNull("nextSunRise")) {
                ...
                if (sunRiseString != null) {
                    ...
                    updateState(new ChannelUID(thing.getUID(), CHANNEL_SUNRISE), new DateTimeType(
                            sunriseInstant.atZone(DirigeraHandlerFactory.TIMEZONE_PROVIDER.getTimeZone())));
                }
            } else {
            ...
            if (!attributes.isNull("nextSunSet")) {
                ...
                if (sunsetString != null) {
                    ...
                    updateState(new ChannelUID(thing.getUID(), CHANNEL_SUNSET), new DateTimeType(
                            sunsetInstant.atZone(DirigeraHandlerFactory.TIMEZONE_PROVIDER.getTimeZone())));
                }
            } else {
