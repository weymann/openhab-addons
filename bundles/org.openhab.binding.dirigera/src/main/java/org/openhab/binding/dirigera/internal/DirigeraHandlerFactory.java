...
public class DirigeraHandlerFactory extends BaseThingHandlerFactory {
    ...
    public static TimeZoneProvider TIMEZONE_PROVIDER = new TimeZoneProvider() {
        @Override
    ...
    public DirigeraHandlerFactory(@Reference StorageService storageService,
            ...
            final @Reference LocationProvider locationProvider, final @Reference TimeZoneProvider timeZoneProvider,
